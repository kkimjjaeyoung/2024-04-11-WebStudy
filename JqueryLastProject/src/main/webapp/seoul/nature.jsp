...
<div class="wrapper row3">
  <main class="container clear"> 
    ...
    <div class="content"> 
      <div id="gallery">
        <figure>
          <header class="heading">자연</header>
          <ul class="nospace clear">
           <c:forEach var="vo" items="${sList }" varStatus="s">
            <li class="one_quarter ${ s.index%4==0?'first':''}"><a href="../seoul/nature_detail.do?fno=${vo.fno }&type=1"><img src="${vo.poster }" title="${vo.title }"></a></li>
           </c:forEach>
          </ul>
        </figure>
      </div>
