    ...
    <form method=post action="../board/update_ok.do">
     <table class="table">
      ...
      <tr>
       ...
       <td width="85%">
        <textarea rows="10" cols="50" name=content required value="${vo.content }"></textarea>
       </td>
      </tr>
      
      <tr>
       <th width=15% class="text-right">파일업로드</th>
       <td width="85%">
        <textarea type="fileupload" cols="30" name=content required value="${vo.fileupload }"></textarea>
       </td>
      </tr>
