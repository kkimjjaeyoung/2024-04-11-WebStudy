...
$(function () {
	$('.dataTr').hover(function){	//마우스 오버 시
	...
	<div class="container">
		<div class="row">
			<div class="text-center">
				<a herf="list.do?type=1" class="btn btn-lg btn-success">일별 박스오피스</a>
				<a herf="list.do?type=2" class="btn btn-lg btn-info">실시간 예매율</a>
				<a herf="list.do?type=3" class="btn btn-lg btn-warning">좌석 점유율</a>
			</div>
		<h3>${title }</h3>
		</div>
		<div class="col-sm-4">
			<table class="table" id="poster">
			<tr>
