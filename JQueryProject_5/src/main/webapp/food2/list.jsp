	...
	<div class="container">
		<div class="row">
			<div class="text-center">
				...
				<input type="button" class="btn btn-lg btn-primary typeBtn" value="일식" onclick="change(3)">
				<input type="button" class="btn btn-lg btn-info typeBtn" value="양식" onclick="change(4)">
