...
function idcheck(){
	window.open("idcheck.do", "postfind", "width=450,  height=400, scrollbars=yes")
}
</script>
</head>
<body>
			...
			<table class="table">
				<tr>
					...
					<td width=80%>
						...
						<input type=button value="아이디 중복 체크" class="btn-sm btn-primary" id="idCheckBtn">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width=80%>
						<input type=text name=id class="input-sm" size=45 readonly>
					</td>
				</tr>
			</table>
		</form>
